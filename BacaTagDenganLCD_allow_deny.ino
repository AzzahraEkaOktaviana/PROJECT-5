...
LiquidCrystal_I2C lcd(0x27, 16, 2);  // Alamat LCD biasanya 0x27 atau 0x3F, sesuaikan dengan modul Anda
...
void loop() {
  ...
  // Bersihkan layar dan siapkan untuk tampilan baru
  lcd.clear();
  lcd.setCursor(0, 0);
  ...
  mfrc522.PICC_HaltA();
  delay(1000);  // Waktu jeda sebelum kembali ke tampilan awal
